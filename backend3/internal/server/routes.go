...
import (
	...
	"github.com/dedegunawan/epnbp.unsil.ac.id-students-backend3/internal/transport/http/user"
...
type Handlers struct {
	...
	StudentBill  *student_bill.StudentBillHandler
...
func RegisterRoutes(r *gin.Engine, h *Handlers, m *Middleware) {
	...
	// Student Bill routes
	protected.GET("/student-bill", h.StudentBill.GetStudentBillStatus)
	protected.POST("/student-bill", h.StudentBill.GenerateCurrentBill)
	protected.POST("/regenerate-student-bill", h.StudentBill.RegenerateCurrentBill)
	protected.GET("/generate/:StudentBillID", h.StudentBill.GenerateUrlPembayaran)
	protected.POST("/confirm-payment/:StudentBillID", h.StudentBill.ConfirmPembayaran)
	protected.GET("/back-to-sintesys", h.StudentBill.BackToSintesys)
